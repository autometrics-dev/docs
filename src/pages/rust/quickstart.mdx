...
<Tabs items={['Expose a endpoint for Prometheus', 'Push to a OpenTelemetry collector']}>
    ...
    <Tab>
        ...
        <table>
            <thead>
                <tr>
                    <th>Feature Flag</th>
                    <th>Transport</th>
                    <th>Client library used</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>
                        <code>otel-push-exporter-http</code>
                    </td>
                    <td>
                        HTTP
                    </td>
                ...
                <tr>
                    <td>
                        <code>otel-push-exporter-grpc</code>
                    </td>
                    <td>
                        gRPC
                    </td>
        ...
        **Runtime**:
        ...
        Simply pick the corresponding feature flags for your setup from each table and add it to the `autometrics` dependency
