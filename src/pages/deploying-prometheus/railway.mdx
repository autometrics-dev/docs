...
In order to make Prometheus accessible to other services in your Railway project or publicly (optional) - you need to tell Railway which port to listen on using the "magic" `PORT` environment variable.
