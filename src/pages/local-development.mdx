...
<Tabs items={["macOS", "Linux"]}>
    ...
    <Tab>
        ...
        curl https://github.com/autometrics-dev/am/releases/latest/download/am-linux-aarch64
        ```
        ```shell filename="x86_64"
        curl https://github.com/autometrics-dev/am/releases/latest/download/am-linux-x86_64
        ```
    </Tab>
